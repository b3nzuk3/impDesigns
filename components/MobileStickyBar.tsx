  ...
  return (
    <>
      <div className="md:hidden fixed bottom-0 inset-x-0 z-40 bg-neutral-950 border-t-2 border-neutral-800 p-3 shadow-2xl flex items-center gap-2">
        <a
          href="https://wa.me/254722404647?text=Hello%20Impact%20Creative%20Designs%20Kenya,%20I%20would%20like%20to%20get%20a%20quote%20for%20custom%20branded%20tapes%20or%20tags."
          target="_blank"
