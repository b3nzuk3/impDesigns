...
const WHATSAPP_URL = siteWhatsAppLink(`Hello ${SITE_NAME}, I would like a quote for custom aluminium tags.`);
...
const FAQS = [
  {
    ...
    a: 'Use 250 tags as an indicative starting quantity for an estimate, not a guaranteed minimum. The actual minimum is confirmed with each quote. Share your quantity, dimensions, artwork, and mounting method so we can review the project.',
  },
  {
    q: 'How long does aluminium tag production take?',
    a: 'Production timing is confirmed with your quote after the quantity, specifications, and artwork are reviewed. Ask for the current lead time for your project.',
  },
  {
    q: 'Can I request aluminium tag samples?',
    a: 'Sample availability is conditional. Ask about sample options for your project; availability and terms are confirmed before a sample is prepared or dispatched.',
  },
  {
      ...
      <section className="pb-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 p-8 bg-white border-2 border-neutral-900 shadow-[6px_6px_0px_#ea580c] text-center space-y-4">
          ...
          <p className="text-xs sm:text-sm text-neutral-600 max-w-lg mx-auto font-sans">
            Share your artwork and specifications with your quotation request. Sample availability is conditional; ask about options and terms before production begins.
          </p>
          <div className="pt-2 flex flex-col sm:flex-row justify-center gap-3">
            ...
            <Link
              href="/quote"
              className="border-2 border-neutral-900 bg-white text-neutral-950 hover:bg-neutral-100 font-mono text-xs sm:text-sm font-bold uppercase py-3.5 px-7 transition-colors"
            >
              Get a quote online
            </Link>
          </div>
